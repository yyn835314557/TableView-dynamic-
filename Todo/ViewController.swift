...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchDisplayDelegate {
    ...
    override func viewDidLoad() {
        ...
        todos = [TodoModel(id: "1", image: "child-selected", title: "1. 去游乐场", date: dateFromString("2015-06-15")!),
                TodoModel(id: "2", image: "shopping-cart-selected", title: "2. 购物", date: dateFromString("2014-06-16")!),
                TodoModel(id: "3", image: "phone-selected", title: "3. 打电话", date: dateFromString("2015-06-17")!),
                TodoModel(id: "4", image: "travel-selected", title: "4. Travel to Europe", date: dateFromString("2015-06-18")!)]
